...
# upstream   https://github.com/MR-Research/ProxmoxVE.git (fetch)
# upstream   https://github.com/MR-Research/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/MR-Research/ProxmoxVE"
echo ""
