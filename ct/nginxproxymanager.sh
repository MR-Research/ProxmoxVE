#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/MR-Research/ProxmoxVE/main/misc/build.func)
...
function update_script() {
  ...
  if [[ $(grep -E '^VERSION_ID=' /etc/os-release) == *"12"* ]]; then
    ...
    msg_error "Please create a snapshot first. You must upgrade your LXC to Debian Trixie before updating. Visit: https://github.com/MR-Research/ProxmoxVE/discussions/7489"
    exit
  fi
