...
service:
  ...
  community-scripts/ProxmoxVE:
    latest_version:
      ...
      use_prerelease: false
    dashboard:
      icon: https://raw.githubusercontent.com/MR-Research/ProxmoxVE/refs/heads/main/misc/images/logo.png
      icon_link_to: https://helper-scripts.com/
      web_url: https://github.com/MR-Research/ProxmoxVE/releases
EOF
msg_ok "Setup Config"
