...
# License: MIT | https://github.com/MR-Research/ProxmoxVED/raw/main/LICENSE

# ==============================================================================
# Docker VM - Creates a Docker-ready Virtual Machine
# ==============================================================================

source <(curl -fsSL https://raw.githubusercontent.com/MR-Research/ProxmoxVE/refs/heads/legacy/16.4/misc/api.func) 2>/dev/null
source <(curl -fsSL https://raw.githubusercontent.com/MR-Research/ProxmoxVE/refs/heads/legacy/16.4/misc/vm-core.func) 2>/dev/null
source <(curl -fsSL https://raw.githubusercontent.com/MR-Research/ProxmoxVE/refs/heads/legacy/16.4/misc/cloud-init.func) 2>/dev/null || true
load_functions
