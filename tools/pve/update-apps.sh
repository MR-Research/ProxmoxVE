...
source <(curl -fsSL https://raw.githubusercontent.com/MR-Research/ProxmoxVE/refs/heads/main/misc/core.func)
...
for container in $CHOICE; do
  ...
  script=$(curl -fsSL https://raw.githubusercontent.com/MR-Research/ProxmoxVE/main/ct/${service}.sh)
